...
")
  ...
  Then(/^I search an user$/) do
    @driver.execute_script("document.getElementsByClassName('ember-power-select-search')[0].childNodes[3].value = 'Daniel'")
    @driver.switch_to.active_element.send_keys(' Velasquez')
  end
